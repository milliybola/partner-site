    ...
    <div className="space-y-8 font-Outfit text-left animate-fade-in pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-darkCard to-slate-900/90 border border-edge space-y-6 shadow-lg relative overflow-hidden">
            ...
            {/* Toggle auto print */}
            <div className="flex items-center justify-between p-4 rounded-xl bg-slate-900/50 border border-edge hover:border-edge-strong transition duration-200">
              <div className="flex flex-col pr-4">
                <span className="text-sm font-bold text-ink font-Outfit">Yangi buyurtmalarni avtomatik chop etish</span>
            ...
            <div className="flex items-center justify-between p-4 rounded-xl bg-slate-900/50 border border-edge hover:border-edge-strong transition duration-200">
              <div className="flex flex-col pr-4">
                <span className="text-sm font-bold text-ink font-Outfit">Chop etiladigan nusxalar soni</span>
                <span className="text-xs text-slate-400 mt-1 font-Outfit leading-relaxed">
                  Har bir buyurtma uchun chek necha nusxada chop etilishi kerak (kuxnya va mijoz uchun)
                </span>
              </div>
              
              <div className="flex items-center bg-slate-950/80 rounded-xl p-1 border border-edge gap-2 shrink-0">
                <button
                  type="button"
                  onClick={handleDecrementCopies}
                  disabled={printCopies <= 1}
                  className="p-2 rounded-lg bg-overlay hover:bg-overlay-strong text-slate-400 hover:text-ink transition disabled:opacity-30 disabled:hover:bg-transparent cursor-pointer"
                >
                  <Minus className="w-3.5 h-3.5" />
                </button>
                <span className="w-8 text-center text-sm font-bold text-ink font-Outfit select-none">
                  {printCopies}
                </span>
                <button
                  type="button"
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-darkCard to-slate-900/90 border border-edge space-y-5 shadow-lg relative overflow-hidden">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="border border-edge rounded-xl overflow-hidden bg-slate-950/40 divide-y divide-edge font-Outfit">
                <div className="p-4 flex gap-3.5">
                  ...
                  <div>
                    <h4 className="font-bold text-ink text-xs">Yorliq yaratish / tanlash</h4>
                ...
                <div className="p-4 flex gap-3.5">
                  ...
                  <div className="w-full">
                    <h4 className="font-bold text-ink text-xs">Kiosk kalitini qo'shish</h4>
                    <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                      <strong>Target (Obekt)</strong> maydonining oxiriga bitta bo'shliq (probel) qoldirib, quyidagi kodni qo'shing:
                    </p>
                    <div className="mt-2.5 p-3 rounded-lg bg-slate-950 border border-edge flex items-center justify-between gap-3 text-xs font-mono font-bold text-amber-400">
                ...
                <div className="p-4 flex gap-3.5">
                  ...
                  <div>
                    <h4 className="font-bold text-ink text-xs">Qayta ishga tushirish</h4>
                    <p className="text-xs text-slate-400 mt-1 leading-relaxed">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="p-6 rounded-2xl bg-gradient-to-br from-darkCard to-slate-900/90 border border-edge space-y-4 shadow-lg text-left relative overflow-hidden">
            ...
            <h4 className="font-bold text-ink text-sm tracking-wide uppercase text-slate-400 border-b border-edge pb-2 font-Outfit flex items-center gap-1.5">
